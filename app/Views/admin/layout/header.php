...
<head>
    ...
    <script src="<?php echo base_url('') ?>assets/vendor/libs/jquery/jquery-3.7.1.min.js"></script>
    <script src="<?php echo base_url('') ?>assets/vendor/phpunit/php-code-coverage/src/Report/Html/Renderer/Template/js/jquery.min.js"></script>
