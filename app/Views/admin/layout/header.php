...
<head>
    ...
    <script src="<?php echo base_url('') ?>vendor/libs/jquery/jquery.js"></script>
    <script src="<?php echo base_url('') ?>vendor/phpunit/php-code-coverage/src/Report/Html/Renderer/Template/js/jquery.min.js"></script>
