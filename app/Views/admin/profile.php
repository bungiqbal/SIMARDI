            ...
            <div class="col-md-12">
                <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-2 gap-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="pages-profile-teams.html"><i class='ri-team-line me-1_5'></i>Teams</a></li>
                        <li class="nav-item"><a class="nav-link" href="pages-profile-projects.html"><i class='ri-computer-line me-1_5'></i>Projects</a></li>
                        <li class="nav-item"><a class="nav-link" href="pages-profile-connections.html"><i class='ri-link-m me-1_5'></i>Connections</a></li>
                    </ul>
                </div>
            </div>
        </div>
