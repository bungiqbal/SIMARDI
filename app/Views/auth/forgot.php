...
<div class="authentication-wrapper authentication-cover">
  ...
  <div class="authentication-inner row m-0">
    ...
    <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center justify-content-center p-12 pb-2">
      <div>
        <img src="<?php echo base_url('') ?>assets/img/illustrations/auth-cover-forgot-password-illustration-light.png" class="authentication-image-model d-none d-lg-block" alt="auth-model" data-app-light-img="illustrations/auth-cover-forgot-password-illustration-light.png" data-app-dark-img="illustrations/auth-cover-forgot-password-illustration-dark.html">
      </div>
    ...
    <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-12 p-6">
      <div class="w-px-400 mx-auto">
        ...
        <p class="mb-5"><?= lang('Auth.enterEmailForInstructions') ?></p>
        <form class="mb-5" action="<?= url_to('forgot') ?>" method="post">
          <?= csrf_field() ?>
          <div class="form-floating form-floating-outline mb-5">
            <input type="email" class="form-control <?php if (session('errors.email')) : ?>is-invalid<?php endif ?>" name="email" aria-describedby="emailHelp" placeholder="<?= lang('Auth.emailAddress') ?>" autofocus>
