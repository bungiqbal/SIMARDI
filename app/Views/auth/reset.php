  ...
  <div class="authentication-wrapper authentication-cover">
    ...
    <div class="authentication-inner row m-0">
      ...
      <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center justify-content-center p-12 pb-2">
        <div>
          <img src="<?php echo base_url('') ?>assets/img/illustrations/auth-cover-reset-password-illustration-light.png" class="authentication-image-model d-none d-lg-block" alt="auth-model" data-app-light-img="illustrations/auth-cover-reset-password-illustration-light.png" data-app-dark-img="illustrations/auth-cover-reset-password-illustration-dark.html">
        </div>
        <img src="<?php echo base_url('') ?>assets/img/illustrations/tree-3.png" alt="tree" class="authentication-image-tree z-n1">
      ...
      <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg position-relative py-sm-5 px-12 py-4">
        <div class="w-px-400 mx-auto pt-5 pt-lg-0">
          <h4 class="mb-1"><?= lang('Auth.resetYourPassword') ?></h4>
          <?= view('Myth\Auth\Views\_message_block') ?>
          <p class="mb-5"><?= lang('Auth.enterCodeEmailPassword') ?></p>
          <form class="mb-5" action="<?= url_to('reset-password') ?>" method="post">
            <?= csrf_field() ?>
            ...
            <div class="mb-5 form-password-toggle">
              <div class="input-group input-group-merge">
                <div class="form-floating form-floating-outline">
                  <input type="password" class="form-control <?php if (session('errors.password')) : ?>is-invalid<?php endif ?>" name="password" placeholder="<?= lang('Auth.newPassword') ?>" autocomplete="off" aria-describedby="password" />
            ...
            <div class="mb-5 form-password-toggle">
              <div class="input-group input-group-merge">
                <div class="form-floating form-floating-outline">
                  <input type="password" class="form-control <?php if (session('errors.pass_confirm')) : ?>is-invalid<?php endif ?>" name="pass_confirm" placeholder="<?= lang('Auth.newPasswordRepeat') ?>" autocomplete="off" aria-describedby="password" />
            ...
            <p class="text-center mb-5">
              <span><?= lang('Auth.cancelPasswordReset') ?></span>
              <a href="<?= url_to('login') ?>">
